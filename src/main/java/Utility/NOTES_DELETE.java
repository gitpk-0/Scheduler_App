...
import Database.FruitsQueryDELETE;
...
public class NOTES_DELETE {
    ...
    /* DATABASE METHODS */
    // int rowsAffected = FruitsQueryDELETE.insert("Cherries", 1);
    // int rowsAffected = FruitsQueryDELETE.update(7, "Red Peppers");
    // int rowsAffected = FruitsQueryDELETE.delete(8);
    ...
    // }
    //
    // FruitsQueryDELETE.select();
    // FruitsQueryDELETE.select(2);
